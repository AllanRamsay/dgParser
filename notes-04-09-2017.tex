...
The first extension is aimed at dealing with \defn{contexts} -- with, for
...
%% or-introduction
prove((P or Q){\IN}C0, LABEL) :-
    (prove(P{\IN}C1, LABEL); prove(Q{\IN}C1, LABEL)),
    C0 << C1.
